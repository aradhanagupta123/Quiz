...
<html>
	...
	<body onload="timeout()">
		...
		<div class="col-lg-12 m-auto d-block">
			...
			<form action="mediumcheck.php" id="q1" method="POST">
			<!--Select the Data--> 
			...
			<?php
				...
				$q = "select * from mediumq where mqid= $i";
			...
			?>
				...
				<div class="card">
					...
					<h4 class="card-header"><?php echo $rows['mquestion']?></h4>
				
					<?php
						
						$q = "select * from mediumans where m_ans_id = $i";
						$query = mysqli_query($conn,$q);
					...
					<div class="card-body">
						...
						<input type="radio" name="quizcheck[<?php echo $rows['m_ans_id'];?>]" value="<?php echo $rows['m_aid'];?>">
						
						<?php echo $rows['m_answer'];?>
